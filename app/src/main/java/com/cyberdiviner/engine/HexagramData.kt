...
object HexagramData {
    ...
    val ALL: List<Hexagram> = listOf(
        ...
        Hexagram(3, "屯", "Zhūn", "Difficulty at the Beginning", "元亨利贞。勿用有攸往，利建侯。", "云雷屯，君子以经纶。",
            listOf(true,false,false,false,true,false), Trigram.KAN, Trigram.ZHEN, "Water",
        ...
        Hexagram(4, "蒙", "Méng", "Youthful Folly", "亨。匪我求童蒙，童蒙求我。", "山下出泉，蒙。君子以果行育德。",
            listOf(false,true,false,false,false,true), Trigram.GEN, Trigram.KAN, "Earth",
        ...
        Hexagram(5, "需", "Xū", "Waiting", "有孚，光亨。贞吉。利涉大川。", "云上于天，需。君子以饮食宴乐。",
            listOf(true,true,true,false,true,false), Trigram.KAN, Trigram.QIAN, "Metal",
        ...
        Hexagram(6, "讼", "Sòng", "Conflict", "有孚窒惕，中吉，终凶。利见大人，不利涉大川。", "天与水违行，讼。君子以作事谋始。",
            listOf(false,true,false,true,true,true), Trigram.QIAN, Trigram.KAN, "Metal",
        ...
        Hexagram(7, "师", "Shī", "The Army", "贞，丈人吉，无咎。", "地中有水，师。君子以容民畜众。",
            listOf(false,true,false,false,false,false), Trigram.KUN, Trigram.KAN, "Earth",
        ...
        Hexagram(8, "比", "Bǐ", "Holding Together", "吉。原筮元永贞，无咎。不宁方来，后夫凶。", "地上有水，比。先王以建万国，亲诸侯。",
            listOf(false,false,false,false,true,false), Trigram.KAN, Trigram.KUN, "Earth",
        ...
        Hexagram(9, "小畜", "Xiǎo Xù", "Taming Power of the Small", "亨。密云不雨，自我西郊。", "风行天上，小畜。君子以懿文德。",
            listOf(true,true,true,false,true,true), Trigram.XUN, Trigram.QIAN, "Wood",
        ...
        Hexagram(10, "履", "Lǚ", "Treading", "履虎尾，不咥人，亨。", "上天下泽，履。君子以辩上下，定民志。",
            listOf(true,true,false,true,true,true), Trigram.QIAN, Trigram.DUI, "Metal",
        ...
        Hexagram(11, "泰", "Tài", "Peace", "小往大来，吉亨。", "天地交，泰。后以财成天地之道，辅相天地之宜，以左右民。",
            listOf(true,true,true,false,false,false), Trigram.KUN, Trigram.QIAN, "Earth",
        ...
        Hexagram(12, "否", "Pǐ", "Standstill", "否之匪人，不利君子贞。大往小来。", "天地不交，否。君子以俭德辟难，不可荣以禄。",
            listOf(false,false,false,true,true,true), Trigram.QIAN, Trigram.KUN, "Metal",
        ...
        Hexagram(13, "同人", "Tóng Rén", "Fellowship", "同人于野，亨。利涉大川。利君子贞。", "天与火，同人。君子以类族辨物。",
            listOf(true,false,true,true,true,true), Trigram.QIAN, Trigram.LI, "Metal",
        ...
        Hexagram(14, "大有", "Dà Yǒu", "Great Possession", "元亨。", "火在天上，大有。君子以遏恶扬善，顺天休命。",
            listOf(true,true,true,true,false,true), Trigram.LI, Trigram.QIAN, "Fire",
        ...
        Hexagram(15, "谦", "Qiān", "Modesty", "亨，君子有终。", "地中有山，谦。君子以裒多益寡，称物平施。",
            listOf(false,false,true,false,false,false), Trigram.KUN, Trigram.GEN, "Earth",
        ...
        Hexagram(16, "豫", "Yù", "Enthusiasm", "利建侯行师。", "雷出地奋，豫。先王以作乐崇德，殷荐之上帝，以配祖考。",
            listOf(false,false,false,true,false,false), Trigram.ZHEN, Trigram.KUN, "Wood",
        ...
        Hexagram(17, "随", "Suí", "Following", "元亨利贞，无咎。", "泽中有雷，随。君子以向晦入宴息。",
            listOf(true,false,false,true,true,false), Trigram.DUI, Trigram.ZHEN, "Metal",
        ...
        Hexagram(18, "蛊", "Gǔ", "Work on What Has Been Spoiled", "元亨，利涉大川。先甲三日，后甲三日。", "山下有风，蛊。君子以振民育德。",
            listOf(false,true,true,false,false,true), Trigram.GEN, Trigram.XUN, "Earth",
        ...
        Hexagram(19, "临", "Lín", "Approach", "元亨利贞。至于八月有凶。", "泽上有地，临。君子以教思无穷，容保民无疆。",
            listOf(true,true,false,false,false,false), Trigram.KUN, Trigram.DUI, "Earth",
        ...
        Hexagram(20, "观", "Guān", "Contemplation", "盥而不荐，有孚颙若。", "风行地上，观。先王以省方观民设教。",
            listOf(false,false,false,false,true,true), Trigram.XUN, Trigram.KUN, "Wood",
        ...
        Hexagram(21, "噬嗑", "Shì Kè", "Biting Through", "亨。利用狱。", "雷电噬嗑。先王以明罚敕法。",
            listOf(true,false,false,true,false,true), Trigram.LI, Trigram.ZHEN, "Wood",
        ...
        Hexagram(22, "贲", "Bì", "Grace", "亨。小利有攸往。", "山下有火，贲。君子以明庶政，无敢折狱。",
            listOf(true,false,true,false,false,true), Trigram.GEN, Trigram.LI, "Earth",
        ...
        Hexagram(23, "剥", "Bō", "Splitting Apart", "不利有攸往。", "山附于地，剥。上以厚下安宅。",
            listOf(false,false,false,false,false,true), Trigram.GEN, Trigram.KUN, "Earth",
        ...
        Hexagram(24, "复", "Fù", "Return", "亨。出入无疾。朋来无咎。反复其道，七日来复。利有攸往。", "雷在地中，复。先王以至日闭关，商旅不行，后不省方。",
            listOf(true,false,false,false,false,false), Trigram.KUN, Trigram.ZHEN, "Earth",
        ...
        Hexagram(25, "无妄", "Wú Wàng", "Innocence", "元亨利贞。其匪正有眚，不利有攸往。", "天下雷行，物与无妄。先王以茂对时育万物。",
            listOf(true,false,false,true,true,true), Trigram.QIAN, Trigram.ZHEN, "Metal",
        ...
        Hexagram(26, "大畜", "Dà Xù", "Taming Power of the Great", "利贞。不家食吉。利涉大川。", "天在山中，大畜。君子以多识前言往行，以畜其德。",
            listOf(false,false,true,true,true,true), Trigram.QIAN, Trigram.GEN, "Metal",
        ...
        Hexagram(31, "咸", "Xián", "Influence", "亨，利贞。取女吉。", "山上有泽，咸。君子以虚受人。",
            listOf(false,false,true,true,true,false), Trigram.DUI, Trigram.GEN, "Metal",
        ...
        Hexagram(32, "恒", "Héng", "Duration", "亨，无咎，利贞。利有攸往。", "雷风恒，君子以立不易方。",
            listOf(false,true,true,true,false,false), Trigram.ZHEN, Trigram.XUN, "Wood",
        ...
        Hexagram(33, "遁", "Dùn", "Retreat", "亨。小利贞。", "天下有山，遁。君子以远小人，不恶而严。",
            listOf(true,true,true,false,false,true), Trigram.GEN, Trigram.QIAN, "Metal",
        ...
        Hexagram(34, "大壮", "Dà Zhuàng", "Power of the Great", "利贞。", "雷在天上，大壮。君子以非礼弗履。",
            listOf(true,true,true,true,false,false), Trigram.ZHEN, Trigram.QIAN, "Wood",
        ...
        Hexagram(35, "晋", "Jìn", "Progress", "康侯用锡马蕃庶，昼日三接。", "明出地上，晋。君子以自昭明德。",
            listOf(false,false,false,true,false,true), Trigram.LI, Trigram.KUN, "Fire",
        ...
        Hexagram(36, "明夷", "Míng Yí", "Darkening of the Light", "利艰贞。", "明入地中，明夷。君子以莅众，用晦而明。",
            listOf(true,false,true,false,false,false), Trigram.KUN, Trigram.LI, "Earth",
        ...
        Hexagram(37, "家人", "Jiā Rén", "The Family", "利女贞。", "风自火出，家人。君子以言有物而行有恒。",
            listOf(true,false,true,false,true,true), Trigram.XUN, Trigram.LI, "Wood",
        ...
        Hexagram(38, "睽", "Kuí", "Opposition", "小事吉。", "上火下泽，睽。君子以同而异。",
            listOf(true,true,false,true,false,true), Trigram.LI, Trigram.DUI, "Fire",
        ...
        Hexagram(39, "蹇", "Jiǎn", "Obstruction", "利西南，不利东北。利见大人，贞吉。", "山上有水，蹇。君子以反身修德。",
            listOf(false,false,true,false,true,false), Trigram.KAN, Trigram.GEN, "Earth",
        ...
        Hexagram(40, "解", "Xiè", "Deliverance", "利西南。无所往，其来复吉。有攸往，夙吉。", "雷雨作，解。君子以赦过宥罪。",
            listOf(false,true,false,true,false,false), Trigram.ZHEN, Trigram.KAN, "Wood",
        ...
        Hexagram(41, "损", "Sǔn", "Decrease", "有孚，元吉，无咎。可贞，利有攸往。曷之用，二簋可用享。", "山下有泽，损。君子以惩忿窒欲。",
            listOf(true,true,false,false,false,true), Trigram.GEN, Trigram.DUI, "Earth",
        ...
        Hexagram(42, "益", "Yì", "Increase", "利有攸往，利涉大川。", "风雷益，君子以见善则迁，有过则改。",
            listOf(true,false,false,false,true,true), Trigram.XUN, Trigram.ZHEN, "Wood",
        ...
        Hexagram(43, "夬", "Guài", "Breakthrough", "扬于王庭，孚号有厉。告自邑。不利即戎。利有攸往。", "泽上于天，夬。君子以施禄及下，居德则忌。",
            listOf(true,true,true,true,true,false), Trigram.DUI, Trigram.QIAN, "Water",
        ...
        Hexagram(44, "姤", "Gòu", "Coming to Meet", "女壮，勿用取女。", "天下有风，姤。后以施命诰四方。",
            listOf(false,true,true,true,true,true), Trigram.QIAN, Trigram.XUN, "Metal",
        ...
        Hexagram(45, "萃", "Cuì", "Gathering Together", "亨。王假有庙，利见大人，亨，利贞。用大牲吉，利有攸往。", "泽上于地，萃。君子以除戎器，戒不虞。",
            listOf(false,false,false,true,true,false), Trigram.DUI, Trigram.KUN, "Water",
        ...
        Hexagram(46, "升", "Shēng", "Pushing Upward", "元亨。用见大人，勿恤。南征吉。", "地中生木，升。君子以顺德，积小以高大。",
            listOf(false,true,true,false,false,false), Trigram.KUN, Trigram.XUN, "Earth",
        ...
        Hexagram(47, "困", "Kùn", "Oppression", "亨，贞，大人吉，无咎。有言不信。", "泽无水，困。君子以致命遂志。",
            listOf(false,true,false,true,true,false), Trigram.DUI, Trigram.KAN, "Water",
        ...
        Hexagram(48, "井", "Jǐng", "The Well", "改邑不改井，无丧无得。往来井井，汔至亦未繘井，羸其瓶，凶。", "木上有水，井。君子以劳民劝相。",
            listOf(false,true,true,false,true,false), Trigram.KAN, Trigram.XUN, "Water",
        ...
        Hexagram(49, "革", "Gé", "Revolution", "己日乃孚。元亨，利贞。悔亡。", "泽中有火，革。君子以治历明时。",
            listOf(true,false,true,true,true,false), Trigram.DUI, Trigram.LI, "Water",
        ...
        Hexagram(50, "鼎", "Dǐng", "The Caldron", "元吉，亨。", "木上有火，鼎。君子以正位凝命。",
            listOf(false,true,true,true,false,true), Trigram.LI, Trigram.XUN, "Fire",
        ...
        Hexagram(51, "震", "Zhèn", "Thunder", "亨。震来虩虩，笑言哑哑。震惊百里，不丧匕鬯。", "洊雷震。君子以恐惧修省。",
            listOf(true,false,false,true,false,false), Trigram.ZHEN, Trigram.ZHEN, "Wood",
        ...
        Hexagram(52, "艮", "Gèn", "Keeping Still", "艮其背，不获其身。行其庭不见其人。无咎。", "兼山艮，君子以思不出其位。",
            listOf(false,false,true,false,false,true), Trigram.GEN, Trigram.GEN, "Earth",
        ...
        Hexagram(53, "渐", "Jiàn", "Development", "女归吉，利贞。", "山上有木，渐。君子以居贤德善俗。",
            listOf(false,false,true,false,true,true), Trigram.XUN, Trigram.GEN, "Wood",
        ...
        Hexagram(54, "归妹", "Guī Mèi", "The Marrying Maiden", "征凶，无攸利。", "泽上有雷，归妹。君子以永终知敝。",
            listOf(true,true,false,true,false,false), Trigram.ZHEN, Trigram.DUI, "Water",
        ...
        Hexagram(55, "丰", "Fēng", "Abundance", "亨，王假之，勿忧，宜日中。", "雷电皆至，丰。君子以折狱致刑。",
            listOf(true,false,true,true,false,false), Trigram.ZHEN, Trigram.LI, "Wood",
        ...
        Hexagram(56, "旅", "Lǚ", "The Wanderer", "小亨。旅贞吉。", "山上有火，旅。君子以明慎用刑而不留狱。",
            listOf(false,false,true,true,false,true), Trigram.LI, Trigram.GEN, "Fire",
        ...
        Hexagram(57, "巽", "Xùn", "The Gentle Wind", "小亨。利有攸往，利见大人。", "随风巽，君子以申命行事。",
            listOf(false,true,true,false,true,true), Trigram.XUN, Trigram.XUN, "Wood",
        ...
        Hexagram(58, "兑", "Duì", "The Joyous", "亨，利贞。", "丽泽兑，君子以朋友讲习。",
            listOf(true,true,false,true,true,false), Trigram.DUI, Trigram.DUI, "Water",
        ...
        Hexagram(59, "涣", "Huàn", "Dispersion", "亨。王假有庙。利涉大川。利贞。", "风行水上，涣。先王以享于帝立庙。",
            listOf(false,true,false,false,true,true), Trigram.XUN, Trigram.KAN, "Wood",
        ...
        Hexagram(60, "节", "Jié", "Limitation", "亨。苦节不可贞。", "泽上有水，节。君子以制数度，议德行。",
            listOf(true,true,false,false,true,false), Trigram.KAN, Trigram.DUI, "Water",
        ...
        Hexagram(62, "小过", "Xiǎo Guò", "Preponderance of the Small", "亨，利贞。可小事，不可大事。飞鸟遗之音，不宜上宜下，大吉。", "山上有雷，小过。君子以行过乎恭，丧过乎哀，用过乎俭。",
            listOf(false,false,true,true,false,false), Trigram.ZHEN, Trigram.GEN, "Earth",
        ...
        Hexagram(63, "既济", "Jì Jì", "After Completion", "亨小，利贞。初吉终乱。", "水在火上，既济。君子以思患而预防之。",
            listOf(true,false,true,false,true,false), Trigram.KAN, Trigram.LI, "Water",
        ...
        Hexagram(64, "未济", "Wèi Jì", "Before Completion", "亨。小狐汔济，濡其尾，无攸利。", "火在水上，未济。君子以慎辨物居方。",
            listOf(false,true,false,true,false,true), Trigram.LI, Trigram.KAN, "Fire",
